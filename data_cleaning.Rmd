...
ggplot(c, aes(Q32)) +  geom_bar(fill = "#0073C2FF")+ geom_text(stat='count', aes(label=..count..),y = 2, color="yellow")  + scale_x_discrete(labels=c("1" = "Mental strain", "2" = "Physical strain","3" = "relationship strain","4" = "NA", "5"= "Financial strain"))
```
...
summary(fit7)
plot(demographics$Q12,demographics$QOL,type="p")
